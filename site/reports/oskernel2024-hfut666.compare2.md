...
- 对比历史仓库：2025 只编译了一次
- 生成时间：2026-06-28T12:50:58.511995+00:00
...
- 与 2025 只编译了一次 的语言构成不同：待测作品为 {'json': 18, 'build': 419, 'markdown': 6579, 'toml': 7, 'asm': 156, 'rust': 8127}，历史样本为 {'json': 20, 'build': 367, 'markdown': 4892, 'toml': 117, 'rust': 12330, 'text': 6, 'c': 1833, 'asm': 366, 'make': 116}。（置信度：medium）
