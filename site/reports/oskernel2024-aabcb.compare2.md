...
- 对比历史仓库：xv6-riscv
- 生成时间：2026-06-29T13:39:34.372806+00:00
...
- 与 xv6-riscv 的语言构成不同：待测作品为 {'json': 18, 'make': 26, 'build': 256, 'markdown': 227, 'c': 6835, 'asm': 308}，历史样本为 {'json': 18, 'build': 199, 'c': 11718, 'asm': 276}。（置信度：medium）
