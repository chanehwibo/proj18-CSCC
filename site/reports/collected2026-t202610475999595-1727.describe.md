# 2026 T202610475999595 项目描述报告

## 基本信息

- 仓库 ID：`collected2026-t202610475999595-1727`
- 风格：ucore-variant
- 架构：未确认
- 样本来源等级：current_contest_case
- 文件数：76
- 代码/文本行数：12564
- 主要语言：c 11886 LOC, asm 276 LOC, markdown 207 LOC, build 195 LOC

## 总览

2026 T202610475999595 是一个 ucore-variant 风格的小型操作系统相关仓库，主要语言统计为 c: 11886 LOC, asm: 276 LOC, markdown: 207 LOC, build: 195 LOC。仓库包含 76 个已扫描文件、约 12564 行可分析文本，当前抽取到 248 个符号定义。
...
| `kernel/proc.h` | L42-L46 | struct trapframe |
...
`struct context` at `kernel/proc.h:L1`、`struct cpu` at `kernel/proc.h:L21`、`struct trapframe` at `kernel/proc.h:L42`
...
`macro SYS_fork` at `kernel/syscall.h:L1`、`macro SYS_exit` at `kernel/syscall.h:L1`、`macro SYS_wait` at `kernel/syscall.h:L2`
